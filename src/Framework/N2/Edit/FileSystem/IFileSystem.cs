...
namespace N2.Edit.FileSystem
{
    ...
    public interface IFileSystem
    {
        ...
        Stream OpenFile(string virtualPath, bool readOnly = false);
        ...
        void ReadFileContents(string virtualPath, Stream outputStream);
        ...
        // option 1: work against a file stream
        ...
        // option 2: writes file content to the output stream
    }
    ...
    public interface IFileSystem2 : IFileSystem
    {
        ...
        void MoveFile(string fromVirtualPath, string destinationVirtualPath, bool supressEvent = false);
    }
}
