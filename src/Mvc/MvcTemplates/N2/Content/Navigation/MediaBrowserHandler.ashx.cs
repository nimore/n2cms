...
namespace N2.Edit.Navigation
{
    ...
    public class MediaBrowserHandler : IHttpHandler
    {
        ...
        private const string RegionHelpers = "HelperUtils";
        private const string RegionPrivateActions = "PrivateActions";
        ...
        private void WriteUploadFile(HttpContext context)
        {
            ...
            try
            {
                ...
                foreach (string file in context.Request.Files)
                {
                    ...
                    var fileName = Regex.Replace(System.IO.Path.GetFileName(fileContent.FileName), EditableFileUploadAttribute.InvalidCharactersExpression, "-");
