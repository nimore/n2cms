...
namespace Dinamico.Controllers
{
	...
	public class StartPageController : ContentController<StartPage>
	{
		...
		{
			get { return Context.Current.Resolve<AccountManager>(); }
		}
		...
		{
			var start = Content.Traverse.StartPage;
		...
		public ActionResult Search(string q)
		{
			...
			var hits = GetSearchResults(CurrentPage ?? Content.Traverse.StartPage, q, 50);
